...
%JAR -cmf generic-manifest.txt Pendulum.jar pendulum/*.class pendulum/images/*.au pendulum/images/*.jpg pendulum/images/achievement/*.jpg pendulum/images/bits/*.jpg pendulum/images/council/*.jpg pendulum/images/playermats/*.jpg pendulum/images/provinces/*.jpg pendulum/images/stratcards/*.jpg
