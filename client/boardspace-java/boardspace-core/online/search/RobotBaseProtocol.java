 ...
 */
public interface RobotBaseProtocol<MOVECLASS> extends SimpleRobotProtocol
{	
	 ...
	 */
	public void setInitialWinRate(UCTNode newChild,int initialVisits,MOVECLASS move,commonMove[]children);
	/**
     ...
     */
    public MOVECLASS Get_Random_Move(Random rand);
     ...
     * @return a move
     */
    public MOVECLASS Get_Reply_Move(MOVECLASS m);
    
    public void Update_Last_Reply(double value,int forPlayer,MOVECLASS prev,MOVECLASS cur);
     ...
     */
    public double Static_Evaluate_Position(MOVECLASS m);
    /**
     ...
     * desired player.
     */
    public double reScorePosition(MOVECLASS cm,int forplayer);
    /**
     ...
     * @return a move spec
     */
    public commonMove targetMoveForEvaluation(MOVECLASS cm);
     ...
     * @param m
     */
    public void Unmake_Move(MOVECLASS m);
    /**
     * call when about to backpropogate unmove of m in the random tree
     * @param m
     */
    public void Backprop_Random_Move(MOVECLASS m,double val);
    /**
     ...
     * @param cm
     */
    public void Make_Move(MOVECLASS cm);
     ...
     */
    public double NormalizedScore(MOVECLASS lastMove);
     ...
     */
    public MOVECLASS getBestWinrateMove(UCTNode parent,Random r,UCTMoveSearcher randomization);
    public double Static_Evaluate_Search_Move(MOVECLASS mm,int current_depth,CommonDriver master);
    public double Static_Evaluate_Uct_Move(MOVECLASS mm,int current_depth,CommonDriver master);
	 ...
	 * @return
	 */
	public boolean needDoneBetween(MOVECLASS next, commonMove current);
	public void setEvaluations(MOVECLASS prev, double preScore);
	public void setGameover(MOVECLASS currentMove, boolean b);
	public void set_depth_limited(MOVECLASS currentMove, EStatus depthLimitedGameover);
	public void setEvaluation(MOVECLASS currentMoveOriginal, double newval);
	public MOVECLASS Random_Good_Move(Search_Driver search_Driver, int n, double dif);
     ...
     */
   // public double NormalizedRescore(MOVECLASS lastMove,double val, int forPlayer);
     ...
     */
    //public boolean WinForPlayer(MOVECLASS lastMove);
}
