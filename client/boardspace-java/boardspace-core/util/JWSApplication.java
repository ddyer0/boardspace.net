 ...
 *
 */
public class JWSApplication implements Config,Runnable,OnlineConstants
{
    ...
    {	init();
		...
		{ 	
	    	...
	    	Http.setHostName(serverName);
	    	String vc = G.getString(VIEWERCLASS,null);
	    	boolean offline = G.getBoolean(OFFLINE,false);
	    	boolean gb = offline || G.getBoolean(REVIEWONLY,false);
