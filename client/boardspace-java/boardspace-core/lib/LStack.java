 ...
 *
 */
public class LStack implements Digestable {
	
	long data[] = new long[5];
	int index = 0;
	public String toString() 
	{
		return("<LStack "+index+" ["+((index>0)?data[index-1]:"")+"]>");
	}
	/**
	 ...
	 */
	public long elementAt(int i) { return(data[i]); }
	 ...
	 * @param other
	 */
	public void copyFrom(LStack other)
	{	clear();
	 ...
	 */
	public boolean sameContents(LStack other)
	{	int sz = size();
		if(sz==other.size())
	 ...
	 */
	public void insert(long value,int indx)
	{	long newEl = value;
		int at = indx;
		while(at<index)
		{
