...
class ChipStack extends OStack<CircleChip>
{
	public CircleChip[] newComponentArray(int n) { return(new CircleChip[n]); }
}
 ...
 *
 */
public class CircleChip extends chip<CircleChip> implements CommonConfig
{
	...
	private CircleChip(String na,double[]sc,CircleId con)
	{	
		scale=sc;
		file = na;
		id = con;
	...
	private CircleChip(String na,double[]sc)
	{	
		scale=sc;
		file = na;
	...
	static public CircleChip Black = new CircleChip("slate",new double[]{0.50,0.510,1.44},CircleId.Black);
	static public CircleChip black_slate_1 = new CircleChip("slate-1",new double[]{0.53,0.40,1.87},null);
	static public CircleChip black_slate_2 = new CircleChip("slate-2",new double[]{0.573,0.420,1.82},null);
	...
	static public CircleChip White = new CircleChip("shell-4",new double[]{0.47,0.49,1.58},CircleId.White);
	static public CircleChip white_stone_5 =  new CircleChip("shell-5",new double[]{0.549,0.432,1.59},null);
	static public CircleChip white_stone_6 =  new CircleChip("shell-6",new double[]{0.54,0.47,1.8},null);
	static public CircleChip white_stone_7 =  new CircleChip("shell-7",new double[]{0.53,0.46,1.98},null);
	static public CircleChip white_stone_8 =  new CircleChip("shell-8",new double[]{0.579,0.487,1.72},null);

	static {
		Black.alternates = new CircleChip[]{ Black, black_slate_2,black_slate_1};
		White.alternates = new CircleChip[]{ White, white_stone_5,white_stone_6,white_stone_7,white_stone_8};
	}
     ...
     * 
     */
	public CircleChip getAltChip(int set)
	{	
		return this;
	}
    ...
    static public CircleChip backgroundTile = new CircleChip("background-tile-nomask",null);
    static public CircleChip backgroundReviewTile = new CircleChip("background-review-tile-nomask",null);
   
    static private double hexScale[] = {0.50,0.50,1.60};
    static private double hexScaleNR[] = {0.58,0.50,1.54};
    static public CircleChip hexTile = new CircleChip("hextile",hexScale,null);
    static public CircleChip hexTile_1 = new CircleChip("hextile-1",hexScale,null);
    static public CircleChip hexTile_2 = new CircleChip("hextile-2",hexScale,null);
    static public CircleChip hexTile_3 = new CircleChip("hextile-3",hexScale,null);
    static public CircleChip hexTileNR = new CircleChip("hextile-nr",hexScaleNR,null);
    static public CircleChip hexTileNR_1 = new CircleChip("hextile-nr-1",hexScaleNR,null);
    static public CircleChip hexTileNR_2 = new CircleChip("hextile-nr-2",hexScaleNR,null);
    static public CircleChip hexTileNR_3 = new CircleChip("hextile-nr-3",hexScaleNR,null);

    static {
    	hexTile.alternates = new CircleChip[] {hexTile,hexTile_1,hexTile_2,hexTile_3};
       	hexTileNR.alternates = new CircleChip[] {hexTileNR,hexTileNR_1,hexTileNR_2,hexTileNR_3};
    }

    public static CircleChip Icon = new CircleChip("circle-icon-nomask",null);
	...
	public static CircleChip cardBack = new CircleChip("cards",null,defaultScale);
