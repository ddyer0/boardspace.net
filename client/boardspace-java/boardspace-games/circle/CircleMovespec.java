...
{	// this is the dictionary of move names
    ...
    public String[] gameEvents() { return(null); }

    public CircleMovespec()
    {
    } // default constructor
     ...
     */
    public CircleMovespec(int opc,char col,int row,int who)
    {
    	op = opc;
     	to_col = col;
    	to_row = row;
    ...
    {
        CircleMovespec other = (CircleMovespec) oth;
    ...
    public void Copy_Slots(CircleMovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
        to.source = source;
    ...
    {
        CircleMovespec yto = (to == null) ? new CircleMovespec() : (CircleMovespec) to;
    ...
    private void parse(Tokenizer msg, int p)
    {
        ...
        case MOVE_DROP:
        case MOVE_PICK:
            source = CircleId.valueOf(msg.nextToken());
            break;
    ...
    {	double chipScale[] = {1.6,0.5,0.2,-0.2};
    	...
    	{	
    		String xx = "xxx";
    		m = TextChunk.join(m,
    				TextGlyph.create(xx, c, v,chipScale)
    					);
    		c = c.next;
    	}
    	return(m);
    ...
    public Text shortMoveText(commonCanvas v)
    {
        ...
        case MOVE_DONE:
            return (critter!=null) ? icon(v,"  x ") : TextChunk.create("");
