...
{	
	...
	public IroCell(Random r,PrototypeId rack) { super(r,rack); }		// construct a cell not on the board
	public IroCell(PrototypeId rack,char c,int r) 		// construct a cell on the board
