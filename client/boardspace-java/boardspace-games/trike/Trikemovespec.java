...
{	// this is the dictionary of move names
     ...
     */
    public Trikemovespec(int opc,char col,int row,int who)
    {
    	op = opc;
     	to_col = col;
    	to_row = row;
    ...
    {
        Trikemovespec other = (Trikemovespec) oth;
    ...
    public void Copy_Slots(Trikemovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
        to.source = source;
    ...
    {
        Trikemovespec yto = (to == null) ? new Trikemovespec() : (Trikemovespec) to;
    ...
    private void parse(StringTokenizer msg, int p)
    {
        ...
        case MOVE_DROP:
        case MOVE_PICK:
            source = TrikeId.valueOf(msg.nextToken());
            break;
