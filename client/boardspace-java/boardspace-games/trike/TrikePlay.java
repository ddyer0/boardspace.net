 ...
 *
 */
public class TrikePlay extends commonRobot<TrikeBoard> implements Runnable, TrikeConstants,
    RobotProtocol
    {
 ...
 */
    ...
    {	Trikemovespec mm = (Trikemovespec)m;
        board.UnExecute(mm);
        boardSearchLevel--;
    }
           ...
           try
           {
              ...
              if (move == null)
               {	// randomn takes the a random element among the first N
                   ...
                   move = (Trikemovespec) search_state.Find_Static_Best_Move(randomn,dif);
               }
           }
           finally
           {
