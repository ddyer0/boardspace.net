 ...
 *
 */
public class PushfightPlay extends commonRobot<PushfightBoard> implements Runnable, PushfightConstants,
    RobotProtocol
    {
    ...
    private int STORAGE_LIMIT = 100000;
    private int FINAL_DEPTH = 99;
    private double NODE_EXPANSION_RATE = 0;			// default, form new nodes on the third visit
    private double CHILD_SHARE = 0.5;				// aggressiveness of pruning "hopeless" children. 0.5 is normal 1.0 is very agressive
  	private PlayoutStrategy playoutStrategy = PlayoutStrategy.PushMore;;
	...
	enum PlayoutStrategy 
		{ Slow,				// no special randomization speedup
		  Fast,				// randomize source and destination separately
		  EdgeAvoidance,	// randomize source and destination, avoiding edges
		  					// seems to help dumbot and not hurt bestbot
		  EasyWin,			// look for easy wins before falling back to edge avoidance
		  PushMore,			// look for pushes (and therefore wins) at all states
		}
 ...
 */
    ...
    {	//int count = Pushfightmovespec.instanceCount;
    	CommonMoveStack l = board.GetListOfMoves();
	 	//int alloc = Pushfightmovespec.instanceCount-count;
	 	//G.print("A "+alloc);
        return(l);
    }
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
        String evaluator, int strategy)
    {
        ...
        GameBoard = (PushfightBoard) gboard;
        ...
        case BESTBOT_LEVEL:
           	...
           	CHILD_SHARE = 0.25;			// conservative pruning of low-probability children
		...
		case DUMBOT_LEVEL:
           	...
           	FINAL_DEPTH = 80;
           	CHILD_SHARE = 0.25;			// conservative pruning of low-probability children
           	NODE_EXPANSION_RATE = 0.5;
        	TIMEPERMOVE = 10;
        	break;
        	
        case MONTEBOT_LEVEL: // 
        	playoutStrategy = PlayoutStrategy.EasyWin;
            	ALPHA = 0.75;
           	FINAL_DEPTH = 80;
           	CHILD_SHARE = 0.25;			// conservative pruning of low-probability children
           	NODE_EXPANSION_RATE = 0.5;
...
{	
 ...
 {	commonMove move = null;
 	...
 	try {
        ...
        double randomn = (RANDOMIZE && (board.getState()==PushfightState.InitialPosition)) 
        						? 0.02
        						: 0.0;
        ...
        monte_search_state.timePerMove = WEAKBOT ? 5 : TIMEPERMOVE;		// seconds per move
        monte_search_state.stored_child_limit = WEAKBOT?10000:STORAGE_LIMIT;
        monte_search_state.verbose = verbose;
        monte_search_state.alpha = ALPHA;
        monte_search_state.blitz = false;			// 
        monte_search_state.sort_moves = false;
        monte_search_state.only_child_optimization = true;
        monte_search_state.dead_child_optimization = true;	// remove unreachable children
        monte_search_state.simulationsPerNode = 1;
        monte_search_state.killHopelessChildrenShare = CHILD_SHARE;
        monte_search_state.final_depth = FINAL_DEPTH;		
        monte_search_state.node_expansion_rate =NODE_EXPANSION_RATE;
        monte_search_state.randomize_uct_children = true;     
        monte_search_state.maxThreads = DEPLOY_THREADS;
        monte_search_state.random_moves_per_second = WEAKBOT ? 10000 : 250000;		// 
        monte_search_state.max_random_moves_per_second = 12000000;		// 
...
public commonMove Get_Random_Move(Random rand)
 {	
	commonMove m = board.getRandomMove(rand,playoutStrategy);
	if(m!=null) { return(m); }
 ...
 {	int player = lastMove.player;
  ...
  {
	  String dir = "g:/share/projects/boardspace-html/htdocs/pushfight/pushfightgames/robot/";
	  saveCurrentVariation(dir+msg+".sgf");
  }
