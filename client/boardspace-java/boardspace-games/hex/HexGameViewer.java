 ...
 */
    ...
    {	G.SetRect(fullRect, x, y, width, height);
    	...
    	// hex board is rectangular, and doesn't have a strong "my side"
    	...
    	G.SetRect(swapButton, boardRight-buttonW, boardY+2*boardH/3, buttonW, buttonW/2);
    	//
   ...
   public Rectangle createPlayerGroup(int player,int x,int y,double rotation,int unitsize)
    ...
    private void DrawChipPool(Graphics gc, Rectangle r, int player, HitPoint highlight,HexGameBoard gb)
    {
        ...
        { // draw a random pile of chips.  It's just for effect
        	hexCell c = bb.getPlayerCell(player);
            ...
            {	int rx = Random.nextInt(rand, spacex);
                ...
                c.drawChip(gc,this,chip.getAltDisplayChip(rx+ry),CELLSIZE,G.Left(r)+CELLSIZE/2+rx,G.Top(r)+CELLSIZE/2+ry,null);
             }
        }
    }
	/**
    ...
    * a game piece, it is really whatever is associated with b.movingObject()
    ...
    { HexGameBoard gb  = disB(gc);
      ...
      if(reviewBackground)
      {	 
       hexChip.backgroundReviewTile.image.tileImage(gc,brect);   
      }
     ...
     */
    public void drawBoardElements(Graphics gc, HexGameBoard gb, Rectangle brect, HitPoint highlight)
    {
        //
 ...
 */
    ...
    {
        return (new Hexmovespec(st, player));
    }
/**
 ...
 */
    ...
    {
        if (hp.hitCode instanceof HexId)// not dragging anything yet, so maybe start
        {
 ...
 */
   ...
   // public commonPlayer startRobot(commonPlayer p,commonPlayer runner,Bot bot)
     ...
     * summary: 1/31/2025
     * 12564 files visited 0 problems
     */
