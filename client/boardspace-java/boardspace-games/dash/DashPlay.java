 ...
 *
 */
public class DashPlay extends commonRobot<DashBoard> implements Runnable, DashConstants,
    RobotProtocol
{   
 ...
 */
    ...
    {	DashMovespec mm = (DashMovespec)m;
    	boardSearchLevel--; 
        board.UnExecute(mm);
    }
 ...
 */
     ...
     * @return
     */
    double ScoreForPlayer(DashBoard evboard,int player,boolean print)
    {	
	 ...
	 DashMovespec move = null;
        ...
        try
        {
            ...
            { // avoid problems with gameover by just supplying a done
                move = new DashMovespec("Done", board.whoseTurn);
            }
