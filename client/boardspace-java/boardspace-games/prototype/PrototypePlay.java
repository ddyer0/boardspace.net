...
public class PrototypePlay extends commonRobot<PrototypeBoard> implements Runnable, PrototypeConstants,
    ...
    private PrototypeChip movingForPlayer = null;	// optional, some evaluators care
 ...
 */
    ...
    {	Prototypemovespec mm = (Prototypemovespec)m;
        board.UnExecute(mm);
        boardSearchLevel--;
    }
 ...
 */
    ...
    {
            PrototypeBoard evboard = GameBoard.cloneBoard();
           ...
           try
           {
              ...
              if (move == null)
               {	// randomn takes the a random element among the first N
                   ...
                   move = (Prototypemovespec) search_state.Find_Static_Best_Move(randomn,dif);
               }
           }
           finally
           {
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
        String evaluator, int strategy)
    {
        ...
        GameBoard = (PrototypeBoard) gboard;
