 ...
 *
 */
public class DayAndNightPlay extends commonRobot<DayAndNightBoard> implements Runnable,
    RobotProtocol
    {
    ...
    public boolean EXP_MONTEBOT = false;		// test version
 ...
 */
    ...
    {	DayAndNightmovespec mm = (DayAndNightmovespec)m;
        board.UnExecute(mm);
        boardSearchLevel--;
    }
 ...
 */
     ...
     */
        ...
        {
            return(board.GetListOfMoves(Generator.Robot));
        }
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
        String evaluator, int strategy)
    {
        ...
        GameBoard = (DayAndNightBoard) gboard;
        ...
        case SMARTBOT_LEVEL:
        	...
        	terminalNodeOptimize = true;
          	break;
          	// montebot is similar to smartbot
        case MONTEBOT_LEVEL:
        	MONTEBOT=true; 
...
{	
    ...
    board.initRobotValues(robotStrategy);
 ...
 {	commonMove move = null;
 	try {
        ...
        monte_search_state.stored_child_limit = CHILD_LIMIT;
        monte_search_state.verbose = 1;//verbose;
        ...
        monte_search_state.final_depth = 40;	// note needed for pushfight which is always finite
        monte_search_state.node_expansion_rate = NODE_EXPANSION_RATE;
        monte_search_state.randomize_uct_children = true;     
        monte_search_state.maxThreads = DEPLOY_THREADS;
        monte_search_state.random_moves_per_second = WEAKBOT ? 15000 : 2700000;		// 
