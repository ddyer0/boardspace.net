...
public class TumbleMovespec extends commonMove implements TumbleConstants
{
    ...
    /* constructor */
    public TumbleMovespec(StringTokenizer ss, int p)
    {
        parse(ss, p);
    }
    ...
    public String moveString()
    {
        ...
        case MOVE_PICKB:
	        return (ind+D.findUnique(op) + " " + from_col + " " + from_row+" "+originalHeight);

		case MOVE_DROPB:
	        return (ind+D.findUnique(op) + " " + to_col + " " + to_row+" "+originalHeight);

		case MOVE_BOARD_BOARD:
			return(ind+D.findUnique(op) + " " + from_col + " " + from_row+" " + to_col + " " + to_row);
        case MOVE_PICK:
            return (ind+D.findUnique(op) + " "+source.shortName+ " "+from_row+" "+originalHeight);

        case MOVE_DROP:
             return (ind+D.findUnique(op) + " "+source.shortName+ " "+to_row+" "+originalHeight);
