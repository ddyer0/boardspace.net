 ...
 */
 ...
 //   }
    ...
    {	commonPlayer pl = getPlayerOrTemp(player);
    	...
    	G.SetRect(chip,	x,	y,	(int)(1.9*unitsize),	2*unitsize);
    ...
    {	int player = pl.boardIndex;
        ...
        { // draw a random pile of chips.  It's just for effect
            ...
            int nc = 20;	
            int dx = G.Left(r)+spacex/3;
            int dy = G.Top(r)+spacey/3;
         // draw 20 chips
    ...
    {  
       ...
       if (state != MeridiansState.Puzzle)
        ...
        standardGameMessage(gc,messageRotation,
            				...
            				state==MeridiansState.Gameover?gameOverMessage():s.get(state.description()),
