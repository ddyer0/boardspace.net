 ...
 *
 */
public class TweedPlay extends commonRobot<TweedBoard> implements Runnable, TweedConstants,
    RobotProtocol
    {
 ...
 */
    ...
    {	TweedMovespec mm = (TweedMovespec)m;
        board.UnExecute(mm);
        boardSearchLevel--;
    }
           ...
           try
           {
              ...
              if (move == null)
               {	// randomn takes the a random element among the first N
                   ...
                   move = (TweedMovespec) search_state.Find_Static_Best_Move(randomn,dif);
               }
           }
           finally
           {
...
{	
    ...
    movingForPlayer = board.whoseTurn();
 ...
 {	commonMove move = null;
 	...
 	try {
        ...
        monte_search_state.blitz = true;			// blitz is 2/3 the speed of normal unwinds
        monte_search_state.sort_moves = false;
        monte_search_state.only_child_optimization = true;
        monte_search_state.dead_child_optimization = true;
        monte_search_state.simulationsPerNode = 1;
        monte_search_state.killHopelessChildrenShare = CHILD_SHARE;
        monte_search_state.final_depth = MOVE_LIMIT;		// 
        monte_search_state.node_expansion_rate = NODE_EXPANSION_RATE;
        monte_search_state.randomize_uct_children = true;     
        monte_search_state.maxThreads = DEPLOY_THREADS;
        monte_search_state.random_moves_per_second = WEAKBOT ? 30000 : 300000;		// 
...
// }
 ...
 {	int player = lastMove.player;
 	...
 	int np = nextPlayer[player];
 	int score1 = board.simpleScore(player);
