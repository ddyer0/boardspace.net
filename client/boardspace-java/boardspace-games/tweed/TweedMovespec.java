...
{	// this is the dictionary of move names
     ...
     */
    public TweedMovespec(int opc,char col,int row,int who)
    {
    	op = opc;
     	to_col = col;
    	to_row = row;
    ...
    {
        TweedMovespec other = (TweedMovespec) oth;
    ...
    public void Copy_Slots(TweedMovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
        to.source = source;
    ...
    {
        TweedMovespec yto = (to == null) ? new TweedMovespec() : (TweedMovespec) to;
    ...
    private void parse(StringTokenizer msg, int p)
    {
        ...
        case MOVE_DROP:
        case MOVE_PICK:
            source = TweedId.valueOf(msg.nextToken());
            break;
    ...
    public Text shortMoveText(commonCanvas v)
    {
		...
		case MOVE_DROPB:
            return icon(v,to_col ,to_row,"=",to_height);
    ...
    public String moveString()
    {
        ...
        case MOVE_PICKB:
		case MOVE_DROPB:
	        return G.concat(opname , to_col , " " , to_row," ",to_height);
