 ...
 */
    ...
    {	CellId id = hp.hitCode;
		...
		if ((state==BreakState.ADJUST_MOVEMENT_STATE) 
			...
			if(G.offline())
				{
				PerformAndTransmit("DoneAdjust "+playerIndex+" "+b.readyString(playerIndex),G.offline(),replayMode.Live);
				}
			else {
        ...
        case MinusOne:
        	{
        	int col = hp.col-'A';;
         	PerformAndTransmit(hitObject.name()+" "+cell.player+" "+cell.index+" "+col,G.offline(),replayMode.Live);
           	}      	 
        	break;
