 ...
 *
 */
public class GygesPlay extends commonRobot<GygesBoard> implements Runnable, 
    RobotProtocol
{   
	private boolean UCT_WIN_LOSS = true;			// if true, score montebot strictly on win/loss
 
    public GygesPlay()	// robot copy requires no-args
    {    	
    }
 ...
 */
    ...
    {	GygesMovespec mm = (GygesMovespec)m;
    	board.UnExecute(mm);
     }
 ...
 */
    ...
    {   //boardCopy = (GygesBoard)board.cloneBoard();
    	CommonMoveStack  moves = board.GetListOfMoves(false);
    	//viewer.recordSolution(monte_search_state,moves.size());
    	return(moves);
    }
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
    ...
    public void InitBoardFromGame()
    {
        ...
        board.pickedSourceStack.clear();
        board.droppedDestStack.clear();
    }
 	...
 	try {
       if (board.DoneState())
        { // avoid problems with gameover by just supplying a done
            move = new GygesMovespec(MOVE_DONE, board.whoseTurn);
        }
        else 
        {
        ...
        monte_search_state.random_moves_per_second = WEAKBOT ? 3000 : 120000;
