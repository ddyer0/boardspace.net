 ...
 *
 */
public class MorrisPlay extends commonRobot<MorrisBoard> implements Runnable, MorrisConstants,
    RobotProtocol
{   
	private boolean UCT_WIN_LOSS = true;			// if true, score montebot strictly on win/loss
	private boolean USE_BLITZ = true;
     /* strategies */
 ...
 */
    ...
    {	MorrisMovespec mm = (MorrisMovespec)m;
    	board.UnExecute(mm);
     }
 	...
 	try {
       if (board.DoneState())
        { // avoid problems with gameover by just supplying a done
            move = new MorrisMovespec(MOVE_DONE, board.whoseTurn);
        }
        else 
        {
        ...
        monte_search_state.final_depth = 199;	// longest possible game
        ...
        monte_search_state.random_moves_per_second =
        		WEAKBOT ? 15000 : USE_BLITZ ? 375000 : 560000;	// unexecute mode
        monte_search_state.blitz = USE_BLITZ;
        //monte_search_state.random_moves_per_second = 383633;	// blitz mode
