...
{	
	...
	private double upBonus = 0.1;	// on top but not adjacent to Q
	
	private double anyDropBonus = 5;			// penalty for having no way to play in
	private double allDropBonus = 0.002;		// per-drop bonus
