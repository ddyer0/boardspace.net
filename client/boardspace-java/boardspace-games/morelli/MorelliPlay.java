 ...
 *
 */
public class MorelliPlay extends commonRobot<MorelliBoard> implements Runnable, MorelliConstants,
    RobotProtocol
{   
 ...
 */
    ...
    {	G.Assert(!BLITZ,"shouldn't be a blitz search");
    	MorelliMovespec mm = (MorelliMovespec)m; 
    	boardSearchLevel--;
    	board.UnExecute(mm);
     }
 ...
 * get a random move by selecting a random one from the full list.
 ...
 {	//return(board.Get_Random_Morelli_Move(rand));
 	...
 	try {
       if (board.DoneState())
        { // avoid problems with gameover by just supplying a done
            move = new MorelliMovespec(MOVE_DONE, board.whoseTurn);
        }
        else 
        {
        ...
        monte_search_state.blitz = BLITZ;
