 ...
 *
 */
public class QyshinsuPlay extends commonRobot<QyshinsuBoard> implements Runnable, QyshinsuConstants,
    RobotProtocol
{   private boolean SAVE_TREE = false;				// debug flag for the search driver
    ...
    private static final int GOODBOT_DEPTH = 8;
    private static final int BESTBOT_DEPTH = 16;	// 20 is barely finite 18 is playable
    private static final int RANDOM_DEPTH = 8;		// max depth if randomizing
 ...
 */
    ...
    {	QyshinsuMovespec mm = (QyshinsuMovespec)m;
    	boardSearchLevel--;
    	board.UnExecute(mm);
     }
 ...
 */
   ...
   public double Static_Evaluate_Position(commonMove m)
    ...
    {
    	QyshinsuBoard evboard = GameBoard.cloneBoard();
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
        String evaluator, int strategy)
    {
        ...
        GameBoard = (QyshinsuBoard) gboard;
	 ...
	 QyshinsuMovespec move = null;
        ...
        try
        {
            ...
            { // avoid problems with gameover by just supplying a done
                move = new QyshinsuMovespec("Done", board.whoseTurn);
            }
            ...
            double dif = 20.0;		// stop randomizing if the value drops this much
            
            if(randomn>0) { depth = Math.min(depth,RANDOM_DEPTH); }
            ...
            if (move == null)
            {
                move = (QyshinsuMovespec) search_state.Find_Static_Best_Move(randomn,dif);
            }
        }
        finally
        {
