 ...
 *
 */
public class CrosswordlePlay extends commonRobot<CrosswordleBoard> implements Runnable, 
    RobotProtocol
    {
 ...
 */
    ...
    {	CrosswordleMovespec mm = (CrosswordleMovespec)m;
        board.UnExecute(mm);
    }
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
        String evaluator, int strategy)
    {
        ...
        GameBoard = (CrosswordleBoard) gboard;
...
{	
 ...
 {	commonMove move = null;
 	try {	startTime = G.Date();
        	...
        	{ move = new CrosswordleMovespec(PASS,board.whoseTurn);	
        	}
        }
 		finally { ; }
