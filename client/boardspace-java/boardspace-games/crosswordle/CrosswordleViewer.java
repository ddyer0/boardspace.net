 ...
 */
    ...
    private void DrawScore(Graphics gc, Rectangle r, commonPlayer pl, HitPoint highlight,CrosswordleBoard gb)
    ...
    * a game piece, it is really whatever is associated with b.movingObject()
    ...
    {	
        ...
        { // note what we hit, row, col, and cell
          ...
          highlight.hitCode = (empty||picked) ? CrosswordleId.EmptyBoard : CrosswordleId.BoardLocation;
 ...
 * not setting the values when the gc is null.
    ...
    public void StopDragging(HitPoint hp)
    {
        ...
        bigString = null;
       	...
       	if(!(id instanceof CrosswordleId))  
