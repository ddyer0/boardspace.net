 ...
 *
 */
public class HoneyPlay extends commonRobot<HoneyBoard> implements Runnable, 
    RobotProtocol
    {
 ...
 */
    ...
    {	Honeymovespec mm = (Honeymovespec)m;
        pboard.UnExecute(mm);
    }
...
{	
	...
	HBoard pb = GameBoard.getPlayerBoard(playerIndex);
 ...
 {	commonMove move = null;
 	try {	startTime = G.Date();
        	...
        	{ move = new Honeymovespec(MOVE_PASS,board.whoseTurn);	
        	}
        }
 		finally { ; }
