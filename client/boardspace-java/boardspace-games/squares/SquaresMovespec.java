...
{	// this is the dictionary of move names
    ...
    SquaresId source; // where from/to
     ...
     */
    public SquaresMovespec(int opc,char col,int row,int who)
    {
    	op = opc;
     	to_col = col;
    	to_row = row;
    ...
    {
        SquaresMovespec other = (SquaresMovespec) oth;
    ...
    public void Copy_Slots(SquaresMovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
        to.source = source;
    ...
    {
        SquaresMovespec yto = (to == null) ? new SquaresMovespec() : (SquaresMovespec) to;
    ...
    private void parse(Tokenizer msg, int p)
    {
        ...
        case MOVE_DROP:
        case MOVE_PICK:
            source = SquaresId.valueOf(msg.nextToken());
            break;
