 ...
 *
 */
public class SquaresPlay extends commonRobot<SquaresBoard> implements Runnable, SquaresConstants,
    RobotProtocol
    {
    ...
    private SquaresChip movingForPlayer = null;	// optional, some evaluators care
 ...
 */
    ...
    {	SquaresMovespec mm = (SquaresMovespec)m;
        board.UnExecute(mm);
        boardSearchLevel--;
    }
 ...
 */
     ...
     * @return
     */
    double ScoreForPlayer(SquaresBoard evboard,int player,boolean print)
    {	
		double val = 0.0;
   ...
   public double Static_Evaluate_Position(	commonMove m)
    ...
    {
            SquaresBoard evboard = GameBoard.cloneBoard();
...
{	
 ...
 // evaluator other than winning a game.
	 // TODO: update squares monte carlo for the new multi-player logic
