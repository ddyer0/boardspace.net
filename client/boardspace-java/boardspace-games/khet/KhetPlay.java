 ...
 *
 */
public class KhetPlay extends commonRobot<KhetBoard> implements Runnable, 
    RobotProtocol
{   
	 ...
	 KhetMovespec move = null;
        ...
        try
        {
            ...
            { // avoid problems with gameover by just supplying a done
                move = new KhetMovespec("Done", board.whoseTurn);
            }
            ...
            int randomn = RANDOMIZE 
            				...
            				: 0;
            int depth = MAX_DEPTH - ((randomn>0)?1:0);	// search depth
