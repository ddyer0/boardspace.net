 ...
 *
 */
public class TicTacNinerPlay extends commonRobot<TicTacNineBoard> implements Runnable, TicTacNineConstants,
    RobotProtocol
 ...
 */
    ...
    {	TicTacNineMovespec mm = (TicTacNineMovespec)m;
    	boardSearchLevel--;
    	board.UnExecute(mm);
     }
 ...
 */
    ...
    {
    	TicTacNineBoard evboard = (TicTacNineBoard)GameBoard.cloneBoard();
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
        String evaluator, int strategy)
    {
        ...
        GameBoard = (TicTacNineBoard) gboard;
        board = (TicTacNineBoard)GameBoard.cloneBoard();
        switch(strategy)
        {case DUMBOT_LEVEL:
	 ...
	 TicTacNineMovespec move = null;
        ...
        try
        {
            ...
            { // avoid problems with gameover by just supplying a done
                move = new TicTacNineMovespec("Done", board.whoseTurn);
            }
            ...
            if (move == null)
            {
                move = (TicTacNineMovespec) search_state.Find_Static_Best_Move(randomn,dif);
            }
        }
        finally
        {
