...
#
.\sign.bat "dave" BSkeystore "g:\share\usr\ddyer\crypto\Boardspace-2020-l4j.p12" "G:\share\projects\boardspace-java\deploy-and-sign\boardspace.net\boardspace.net.exe"
