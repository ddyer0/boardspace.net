...
public class MeridiansMovespec 
...
{	// this is the dictionary of move names
    ...
    /* constructor */
    public MeridiansMovespec(StringTokenizer ss, int p)
    {
        parse(ss, p);
    }
    ...
    {
        MeridiansMovespec yto = (to == null) ? new MeridiansMovespec() : (MeridiansMovespec) to;
