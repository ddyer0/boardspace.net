 ...
 *
 */
public class MeridiansPlay extends commonRobot<MeridiansBoard> implements Runnable, MeridiansConstants,
    RobotProtocol
    {
    ...
    private MeridiansChip movingForPlayer = null;	// optional, some evaluators care
    ...
    {	RobotProtocol c = super.copyPlayer(from);
    	MeridiansPlay cc = (MeridiansPlay)c;
 ...
 */
     ...
     * @return
     */
    double ScoreForPlayer(MeridiansBoard evboard,int player,boolean print)
    {	
		double val = 0.0;
    ...
    {
            MeridiansBoard evboard = GameBoard.cloneBoard();
           ...
           try
           {
              ...
              if (move == null)
               {	// randomn takes the a random element among the first N
                   ...
                   move = (MeridiansMovespec) search_state.Find_Static_Best_Move(randomn,dif);
               }
           }
           finally
           {
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
        String evaluator, int strategy)
    {
        ...
        GameBoard = (MeridiansBoard) gboard;
