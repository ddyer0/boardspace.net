 ...
 *
 */
public class GounkiPlay extends commonRobot<GounkiBoard> implements Runnable,
    RobotProtocol
{   
    ...
    static final int WEAKBOT_DEPTH = 4;
    static final int DUMBOT_DEPTH = 5;
 ...
 */
    ...
    {	GounkiMovespec mm = (GounkiMovespec)m;
    	boardSearchLevel--;
    	board.UnExecute(mm);
     }
	 ...
	 GounkiMovespec move = null;
        ...
        try
        {
            ...
            { // avoid problems with gameover by just supplying a done
                move = new GounkiMovespec("Done", board.whoseTurn);
            }
            ...
            if (move == null)
            {
                move = (GounkiMovespec) search_state.Find_Static_Best_Move(randomn,dif);
            }
        }
        finally
        {
