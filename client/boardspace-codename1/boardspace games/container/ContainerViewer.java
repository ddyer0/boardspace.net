				...
				labelFont = largeBoldFont();
				 ...
				 {Color cc = labelColor;
				  ...
				  {	// drawing the goal card
					  ...
					  boolean canShow = itsMe || allPlayersLocal() ;
 ...
 public void ViewerRun(int wait)
  {
    ...
    public void ReplayGame(sgf_game ga) 
    	{ versionValue = SGF_GAME_VERSION; 
    	  ...
    	  {
    		  theChat.postMessage(ChatInterface.GAMECHANNEL, null,null,ChatInterface.KEYWORD_CHAT,b.complaints.elementAt(i)); 
    	  }
    	}
    ...
    public void drawHiddenWindow(Graphics gc,HitPoint hp,int myIndex,Rectangle bounds)
    {
		...
		Font myfont = FontManager.getFont(largeBoldFont(),G.Height(nameRect)/2);
