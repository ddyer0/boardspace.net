...
{	// this is the dictionary of move names
    ...
    HavannahId source; // where from/to
    char to_col; // for from-to moves, the destination column
    int to_row; // for from-to moves, the destination row
    
    public HavannahMovespec()
    {
    } // default constructor
     ...
     */
    public HavannahMovespec(int opc,char col,int row,HavannahId what,int who)
    {
    	op = opc;
    	source = what;
    	to_col = col;
    ...
    {
        HavannahMovespec other = (HavannahMovespec) oth;
    ...
    public void Copy_Slots(HavannahMovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
        to.source = source;
    ...
    {
        HavannahMovespec yto = (to == null) ? new HavannahMovespec() : (HavannahMovespec) to;
    ...
    private void parse(StringTokenizer msg, int p)
    {
        ...
        case MOVE_DROP:
        case MOVE_PICK:
            source = HavannahId.get(msg.nextToken());
