 ...
 *
 */
public class KubaPlay extends commonRobot<KubaBoard>implements Runnable,
    RobotProtocol
{	
	...
	private static final int BESTBOT_DEPTH = 11;
 ...
 */
    ...
    {	KubaMovespec mm = (KubaMovespec)m;
    	boardSearchLevel--;
    	board.UnExecute(mm);
     }
