 ...
 *
 */
public class MijnlieffPlay extends commonRobot<MijnlieffBoard> implements Runnable, RobotProtocol
    {
 ...
 */
    ...
    {	Mijnlieffmovespec mm = (Mijnlieffmovespec)m;
        board.UnExecute(mm);
        boardSearchLevel--;
    }
 ...
 */
 public void InitRobot(ViewerProtocol newParam, ExtendedHashtable info, BoardProtocol gboard,
        String evaluator, int strategy)
    {
        ...
        GameBoard = (MijnlieffBoard) gboard;
...
{	
 ...
 {	commonMove move = null;
 	try {
        ...
        monte_search_state.final_depth = 100;		// not needed for mijnlieff which is always finite
        monte_search_state.node_expansion_rate = NODE_EXPANSION_RATE;
        monte_search_state.randomize_uct_children = true;     
        monte_search_state.maxThreads = DEPLOY_THREADS;
        monte_search_state.random_moves_per_second = WEAKBOT ? 13000 : 1300000;		// 
        monte_search_state.max_random_moves_per_second = 2300000;		// 
