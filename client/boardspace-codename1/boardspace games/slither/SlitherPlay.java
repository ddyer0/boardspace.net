 ...
 */
     ...
     * @return
     */
    double ScoreForPlayer(SlitherBoard evboard,int player,boolean print)
    {	
		double val = 0.0;
           ...
           try
           {
              ...
              if (move == null)
               {	// randomn takes the a random element among the first N
                   ...
                   move = (Slithermovespec) search_state.Find_Static_Best_Move(randomn,dif);
               }
           }
           finally
           {
...
{	
 ...
 // evaluator other than winning a game.
	 // TODO: update slither monte carlo for the new multi-player logic
