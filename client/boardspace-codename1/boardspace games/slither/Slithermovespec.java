...
{	// this is the dictionary of move names
    ...
    public Slithermovespec(int opc,SlitherCell from,int p)
    {
    	from_col = to_col = from.col;
    	from_row = to_row = from.row;
     	op = opc;
    	player = p;
    }
    public Slithermovespec(int opc,SlitherCell from,SlitherCell to,int p)
    {
    	from_col = from.col;
    	from_row = from.row;
    	to_col = to.col;
     ...
     */
    public Slithermovespec(int opc,char col,int row,int who)
    {
    	op = opc;
     	to_col = col;
    	to_row = row;
    ...
    {
        Slithermovespec other = (Slithermovespec) oth;
    ...
    public void Copy_Slots(Slithermovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
    ...
    {
        Slithermovespec yto = (to == null) ? new Slithermovespec() : (Slithermovespec) to;
    ...
    private void parse(StringTokenizer msg, int p)
    {
        ...
        case MOVE_PICK:
        	from_col = to_col = '@';
        	from_row = to_row = SlitherId.valueOf(msg.nextToken()).ordinal();
            break;
