...
{	// this is the dictionary of move names
     ...
     */
    public BugMovespec(int opc,char col,int row,int who)
    {
    	op = opc;
     	to_col = col;
    	to_row = row;
    ...
    {
        BugMovespec other = (BugMovespec) oth;
    ...
    public void Copy_Slots(BugMovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
        to.source = source;
    ...
    {
        BugMovespec yto = (to == null) ? new BugMovespec() : (BugMovespec) to;
    ...
    private void parse(Tokenizer msg, int p)
    {
        ...
        case MOVE_DROP:
        case MOVE_PICK:
            source = BugId.valueOf(msg.nextToken());
            break;
    ...
    {	double chipScale[] = {1.6,1,0.2,-0.2};
