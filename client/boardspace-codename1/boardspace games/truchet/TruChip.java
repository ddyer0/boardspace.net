...
public class TruChip extends chip<TruChip>
{	enum ChipColor { white,black };
	...
	public TruChip(ChipColor pla,int idx,int []ci,Image im,double sc[],long rn)
	{	color=pla;
		colorInfo = ci;
		chipNumber=idx;
		image = im;
    ...
    static private TruChip CANONICAL_PIECE[] = null;	// created by preload_images
	...
	{light_scale,	dark_scale,	// light r0 dark r0
	 ...
	 {0.317,0.691,1.64},		// white chip
	 {0.324,0.668,1.64},	// black chip
	};
   ...
   static final String[] MaskFileNames = 
	...
	"light-tile-mask","dark-tile-mask",
	"light-tile-mask","dark-tile-mask",
    "white-chip-np-mask","black-chip-np-mask"
   };
    ...
    static public TruChip getChip(int i) { return(CANONICAL_PIECE[i]); }
	...
	{	if(CANONICAL_PIECE==null)
        ...
        TruChip CC[]=new TruChip[nColors];
        for(int i=0;i<nColors;i++)
        {
        ChipColor cl = i==BLACK_CHIP_INDEX
        				? ChipColor.black 
        				: i==WHITE_CHIP_INDEX
        					? ChipColor.white
        					: null;
