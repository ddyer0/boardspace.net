...
{	// this is the dictionary of move names
    ...
    static final int MOVE_STALEMATE = 210;	// no moves, legitimately
    static
    {	// load the dictionary
     ...
     */
    public KingsColormovespec(int opc,char col,int row,int who)
    {
    	op = opc;
     	to_col = col;
    	to_row = row;
    ...
    public KingsColormovespec(int opc,KingsColorCell from, KingsColorCell to, int who) {
		 op = opc;
		 from_col = from.col;
		 from_row = from.row;
		 to_col = to.col;
    ...
    {
        KingsColormovespec other = (KingsColormovespec) oth;
    ...
    public void Copy_Slots(KingsColormovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
        to.source = source;
    ...
    {
        KingsColormovespec yto = (to == null) ? new KingsColormovespec() : (KingsColormovespec) to;
    ...
    {	
    	if( (from_col=='K' && from_row==4 && to_col=='L' && to_row==5))
    	{
    		//UCTNode uct = uctNode();
