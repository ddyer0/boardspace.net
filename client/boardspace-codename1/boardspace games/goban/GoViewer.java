...
{	
   ...
   // }
    ...
    public void setLocalBounds(int x, int y, int width, int height)
    {
        ...
        int buttonW = fh*8;
        int margin = fh/2;
       	int undosize = Math.max(FontManager.getFontMetrics(standardBoldFont()).stringWidth(s.get(UndoRequest)),
       						buttonW*2+margin*2);
        ...
        {	boolean doneState = b.DoneState();
            ...
            if (GC.handleRoundButton(gc, doneRect, 
        		...
        		if(undoPending) 
        		{
        			...
        			HitPoint hit = allPlayersLocal()|reviewOnly|!undoRequest ? highlight : null;
