...
class CellStack extends OStack<GraphicsCell>
{
	public GraphicsCell[] newComponentArray(int n) { return(new GraphicsCell[n]); }
}
/**
...
public class GraphicsCell
	...
	extends stackCell<GraphicsCell,GraphicsChip>
{	

	public GraphicsCell(Random r,PrototypeId rack) { super(r,rack); }		// construct a cell not on the board
	public GraphicsCell(PrototypeId rack,char c,int r) 		// construct a cell on the board
	 ...
	 */
	public boolean sameCell(GraphicsCell other)
	 ...
	 * 
	 */
	public void copyFrom(GraphicsCell ot)
	...
	public GraphicsCell(GraphicsChip cont)
	{	super();
		addChip(cont);
		onBoard=false;
	}
	...
	public GraphicsChip[] newComponentArray(int size) {
		return(new GraphicsChip[size]);
	}
	/**
