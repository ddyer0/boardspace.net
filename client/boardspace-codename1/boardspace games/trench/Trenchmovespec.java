...
{	// this is the dictionary of move names
    ...
    static final int MOVE_CAPTURE = 209;
    static final int MOVE_ATTACK = 210;
     ...
     */
    public Trenchmovespec(int opc,char col,int row,int who)
    {
    	op = opc;
     	to_col = col;
    	to_row = row;
    ...
    {
        Trenchmovespec other = (Trenchmovespec) oth;
    ...
    public void Copy_Slots(Trenchmovespec to)
    {	super.Copy_Slots(to);
        to.to_col = to_col;
        to.to_row = to_row;
        to.source = source;
    ...
    {
        Trenchmovespec yto = (to == null) ? new Trenchmovespec() : (Trenchmovespec) to;
