 ...
 */
    ...
    {	RajBoard.PlayerBoard pb = gb.getPlayerBoard(pl);
    	...
    	{	highlight.setHelpText(s.get(UsedCardsMessage));
     	...
     	{	
            ...
            boolean canHitCards = (allowed_to_edit||(!isSpectator() && (allPlayersLocal()||(getActivePlayer().boardIndex==pl)))) 
    ...
    * */
    private void drawBoardElements(Graphics gc, RajBoard gb, Rectangle brect, HitPoint highlight)
    {
        ...
        boolean anyhit = allPlayersLocal() 
    ...
    {	RajCell hitCell = hitCell(hp);
       ...
       case PlayerDiscards:
	    ...
	    case BoardLocation:
	    	...
	    	if(obj.isCard() && (allPlayersLocal() || (simultaneousTurnsAllowed())))
