...
{   boolean SAVE_TREE = false;				// debug flag for the search driver
    ...
    boolean FASTRANDOM = true;
    double ordoMoveProbability = 0.1;
 ...
 {
	 super.copyFrom(from);
	 OrdoPlay ot = (OrdoPlay)from;
	 ordoMoveProbability = ot.ordoMoveProbability;
	 FASTRANDOM = ot.FASTRANDOM;
 }
    //
 ...
 * get a random move by selecting a random one from the full list.
 ...
 {	
	 commonMove m = FASTRANDOM ? board.Get_Random_Move(rand,ordoMoveProbability) : null;
	 if(m!=null) { return m; }
