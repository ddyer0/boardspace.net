...
/*
 this is a slightly modified copy of the OpenJdk version of the same code.
 */
...
public class AffineTransform 
{
    ...
    public Point2D transform(Point2D ptSrc, Point2D ptDst) {
        if (ptDst == null) {
                ptDst = Graphics.newPoint2D(ptSrc);
            }
        ...
        default:
            ...
            return null;
        case (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE):
        	Graphics.setLocation(ptDst,x * m00 + y * m01 + m02,x * m10 + y * m11 + m12);
            return ptDst;
        case (APPLY_SHEAR | APPLY_SCALE):
        	Graphics.setLocation(ptDst,x * m00 + y * m01,x * m10 + y * m11);
            return ptDst;
        case (APPLY_SHEAR | APPLY_TRANSLATE):
        	Graphics.setLocation(ptDst,y * m01 + m02,x * m10 + m12);
            return ptDst;
        case (APPLY_SHEAR):
        	Graphics.setLocation(ptDst,y * m01,x * m10);
            return ptDst;
        case (APPLY_SCALE | APPLY_TRANSLATE):
        	Graphics.setLocation(ptDst,x * m00 + m02,y * m11 + m12);
            return ptDst;
        case (APPLY_SCALE):
        	Graphics.setLocation(ptDst,x * m00,y * m11);
            return ptDst;
        case (APPLY_TRANSLATE):
        	Graphics.setLocation(ptDst,x + m02,y + m12);
            return ptDst;
        case (APPLY_IDENTITY):
        	Graphics.setLocation(ptDst,x,y);
            return ptDst;
        }
    ...
    public void transform(Point2D[] ptSrc, int srcOff,
        ...
        while (--numPts >= 0) {
            ...
            default:
                ...
                return;
            case (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE):
            	Graphics.setLocation(dst,x * m00 + y * m01 + m02,x * m10 + y * m11 + m12);
                break;
            case (APPLY_SHEAR | APPLY_SCALE):
            	Graphics.setLocation(dst,x * m00 + y * m01,x * m10 + y * m11);
                break;
            case (APPLY_SHEAR | APPLY_TRANSLATE):
            	Graphics.setLocation(dst,y * m01 + m02,x * m10 + m12);
                break;
            case (APPLY_SHEAR):
            	Graphics.setLocation(dst,y * m01,x * m10);
                break;
            case (APPLY_SCALE | APPLY_TRANSLATE):
            	Graphics.setLocation(dst,x * m00 + m02,y * m11 + m12);
                break;
            case (APPLY_SCALE):
            	Graphics.setLocation(dst,x * m00,y * m11);
                break;
            case (APPLY_TRANSLATE):
            	Graphics.setLocation(dst,x + m02,y + m12);
                break;
            case (APPLY_IDENTITY):
            	Graphics.setLocation(dst,x,y);
                break;
            }
        }
        ...
        throws Exception
    {
        ...
        case (APPLY_SHEAR | APPLY_SCALE):
            ...
            Graphics.setLocation(ptDst,(x * m11 - y * m01) / det,(y * m00 - x * m10) / det);
            return ptDst;
        case (APPLY_SHEAR | APPLY_TRANSLATE):
            x -= m02;
            y -= m12;
        ...
        case (APPLY_SHEAR):
        	...
        	Graphics.setLocation(ptDst,y / m10,x / m01);
            return ptDst;
        case (APPLY_SCALE | APPLY_TRANSLATE):
            x -= m02;
            y -= m12;
    ...
    {	if(from==null) { from = Graphics.newPoint2D(null);}
    	if(to==null) { to = Graphics.newPoint2D(null); }
    	Graphics.setLocation(from,x,y);
     	transform(from,to);
    	return to;
    }
