...
public class ResourcesCopy {
     ...
     */
    private static ResourcesCopy globalResources;
    
    /**
     * This variable is used to cache the system resources file CN1Resource.res
     */
    private static ResourcesCopy systemResource;
    ...
    private static Class classLoader = ResourcesCopy.class;
    ...
    ResourcesCopy(InputStream input, int dpi) throws IOException {
        this.dpi = dpi;
        openFile(input);
    }
     ...
     */
    public static ResourcesCopy openLayered(String resource) throws IOException {
     ...
     * @throws java.io.IOException if opening/reading the resource fails
     */
    public static ResourcesCopy open(String resource) throws IOException {
     ...
     * @throws java.io.IOException if opening/reading the resource fails
     */
    public static ResourcesCopy open(InputStream resource) throws IOException {
        return open(resource, -1);
    }    
     ...
     * @throws java.io.IOException if opening/reading the resource fails
     */
    public static ResourcesCopy openLayered(String resource, int dpi) throws IOException {
        ResourcesCopy r = open(resource + ".res", dpi);
     ...
     * @throws java.io.IOException if opening/reading the resource fails
     */
    public static ResourcesCopy open(String resource, int dpi) throws IOException {
        try {
            if (resource.equals(ResourcesCopy.systemResourceLocation) && systemResource != null) {
                return systemResource;
            }
            if(lastLoadedName != null && lastLoadedName.equals(resource) && lastLoadedDPI == dpi) {
                ResourcesCopy r = (ResourcesCopy)Display.getInstance().extractHardRef(cachedResource);
                if(r != null) {
                    return r;
                }
            }
            ...
            ResourcesCopy r = new ResourcesCopy(is, dpi);
            is.close();
            
            if(resource.equals(ResourcesCopy.systemResourceLocation)){
                systemResource = r;
                return r;
            }
     ...
     * @throws java.io.IOException if opening/reading the resource fails
     */
    public static ResourcesCopy open(InputStream resource, int dpi) throws IOException {
        return new ResourcesCopy(resource, dpi);
    }
     ...
     * 
     * @return a ResourcesCopy object which contains the system resources
     */
    public static ResourcesCopy getSystemResource(){
        try {
     ...
     */
    public static void setGlobalResources(ResourcesCopy res) {
        globalResources = res;
    }
     ...
     */
    public static ResourcesCopy getGlobalResources() {
