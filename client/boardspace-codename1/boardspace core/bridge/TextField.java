...
public class TextField extends com.codename1.ui.EditField
{
	...
	public int getBackgroundColor() { return(getStyle().getBgColor()); }
	public int getForegroundColor() { return(getStyle().getFgColor()); }
