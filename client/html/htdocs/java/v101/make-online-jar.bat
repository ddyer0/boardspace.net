...
set CN1=g:/share/projects/boardspace-codename1/boardspace games/
set CN1B=g:/share/projects/boardspace-codename1/boardspace core/


%JAR% -cmf generic-manifest.txt Sounds.jar bfms/*.wav
%JAR% -cf "%CN1B%bsdata.zip" bfms/*.wav online/images/*.jpg online/images/*.png -C "%CN1B%../" images
%JAR% -cmf generic-manifest.txt Language.jar languages/translations/*.data
%JAR% -cf "%CN1%languages.zip" languages/translations/*.data

%JAR% -cmf generic-manifest.txt Icons.jar -C "g:/share/projects/boardspace-java/boardspace-games/" "icons"
%JAR% -cf "%CN1%icons.zip" -C "g:/share/projects/boardspace-java/boardspace-games/" "icons"

rem the rest of new games can follow this pattern, create the same images as a zip for codename1 to use
rem 
%JAR% -cmf generic-manifest.txt Hexade.jar hexade/*.class hexade/images/*.jpg 
%JAR% -cf "%CN1%hexade.zip" hexade/images/*.jpg 
...
%JAR% -cmf generic-manifest.txt Warp6.jar warp6/*.class warp6/images/*.jpg warp6/images/*.wav
...
%JAR% -cmf generic-manifest.txt Mutton.jar mutton/*.class mutton/images/*.jpg mutton/images/*.png mutton/sounds/*.wav
...
%JAR% -cmf generic-manifest.txt Arimaa.jar arimaa/*.class arimaa/images/*.jpg arimaa/images/*.wav
%JAR% -cmf generic-manifest.txt Crossfire.jar crossfire/*.class crossfire/images/*.jpg
%JAR% -cmf generic-manifest.txt Quinamid.jar quinamid/*.class quinamid/images/*.jpg quinamid/images/*.wav
...
%JAR% -cmf generic-manifest.txt Yspahan.jar yspahan/*.class yspahan/images/*.jpg yspahan/images/*.wav
...
%JAR% -cmf generic-manifest.txt Euphoria.jar euphoria/*.class euphoria/images/*.jpg euphoria/sounds/*.wav euphoria/images/artifacts/*.jpg euphoria/images/dice/*.jpg euphoria/images/markets/*.jpg euphoria/images/dilemmas/*.jpg euphoria/images/recruits-v12/*.jpg euphoria/images/recruits-iib/*.jpg
...
%JAR% -cmf generic-manifest.txt Viticulture.jar viticulture/images/*.wav viticulture/*.class viticulture/images/automata/back.jpg  viticulture/images/automata/back-mask.jpg viticulture/images/*.jpg viticulture/images/choice/*.jpg viticulture/images/mamas-cropped/*.jpg viticulture/images/papas-cropped/*.jpg viticulture/images/specialworkers-cropped/*.jpg viticulture/images/structurecards-cropped/*.jpg viticulture/images/summer-cropped/*.jpg viticulture/images/vinecards-cropped/*.jpg viticulture/images/wineorders-cropped/*.jpg viticulture/images/wintervisitor-cropped/*.jpg
...
%JAR% -cmf generic-manifest.txt Dice.jar dice/*.class dice/images/*.jpg dice/images/*.wav
...
%JAR% -cmf generic-manifest.txt Imagine.jar imagine/*.class imagine/images/*.jpg imagine/images/*.wav imagine/images/deck1/*.jpg
...
%JAR% -cmf generic-manifest.txt HoneyComb.jar honey/*.class honey/images/*.jpg
%JAR% -cmf generic-manifest.txt Gametimer.jar gametimer/*.class gametimer/images/*.jpg
%JAR% -cmf generic-manifest.txt Manhattan.jar manhattan/*.class manhattan/images/*.jpg
%JAR% -cmf generic-manifest.txt Epaminondas.jar epaminondas/*.class epaminondas/images/*.jpg
%JAR% -cmf generic-manifest.txt Circle.jar circle/*.class circle/images/*.jpg
%JAR% -cmf generic-manifest.txt Pendulum.jar pendulum/*.class pendulum/images/*.wav pendulum/images/*.jpg pendulum/images/achievement/*.jpg pendulum/images/bits/*.jpg pendulum/images/council/*.jpg pendulum/images/playermats/*.jpg pendulum/images/provinces/*.jpg pendulum/images/stratcards/*.jpg
%JAR% -cmf generic-manifest.txt Slither.jar slither/*.class slither/images/*.jpg
%JAR% -cmf generic-manifest.txt Bug.jar bug/*.class bug/images/*.jpg 
