 ...
 * @author Shai Almog
 */
public class DtestStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Dtest";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new DtestStub());
    }
